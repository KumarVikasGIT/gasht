...
class PropertyList extends StatefulWidget {
  ...
  int propertyId;
   PropertyList(
       this.startDate,this.endDate,this.cityId,this.propertyId,
...
class _PropertyList extends State<PropertyList> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
                ...
                child:  Row(
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Image.asset("assets/images/arrowBack.png", width: 40,height: 40,),
      ...
      */
                ...
                return  Expanded(
                  child: propertyList.isNotEmpty ? ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      if(propertyList[index].discount.toString()=="0%")
                        ...
                        {
                           discount = "${propertyList[index].discount.toString()} Off";
                      ...
                      return  InkWell(
                              ...
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: IconButton(
                                      onPressed: () {
                                        if (!wishlistController.isInWishlist(propertyList[index])) {
                                          wishlistController.addToWishlist(propertyList[index]);
                                          Get.snackbar("Added to wishlist", "",
                                              colorText: Colors.white,
                                              snackPosition: SnackPosition.BOTTOM,
                                              backgroundColor: Colors.green);
                                        } else {
                                          wishlistController.removeFromWishlist(propertyList[index]);
                                      ...
                                      icon: Obx(() => Icon(
                                        wishlistController.isInWishlist(propertyList[index])
                                            ? Icons.favorite
                                            : Icons.favorite_border_outlined,
                                        color: wishlistController.isInWishlist(propertyList[index])
                                            ? Colors.red
                                            : null,
                                      ),
                                      ),
                        ...
                        onTap: (){
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) =>    PropertyDetails(propertyList[index],widget.startDate,widget.endDate),//const PlayList( tag: 'Playlists',title:'Podcast'),
                            ),
                          );
  ...
  Future<PropertyObjects> getPropertyList() async {
    ...
    try {
      return apiharmattanface.getPropertyList(token??"",widget.cityId, widget.startDate,widget.endDate, widget.propertyId);
    } catch (e) {
      ...
      Container(
        ...
        child: Center(
          child: Column(
            children: [
            const  SizedBox(height: 10,),
              const Text("Select the price range", style: TextStyle(fontSize: 18),),
        ...
        child: Column(
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemCount: _proType.cityList.length,//_proType.cityList.length,
                ...
                return Container(
                    ...
                    InkWell(
                      ...
                      Row(children: [
                        ...
                        CircleAvatar(
                            radius: 30, // Image radius
                            backgroundImage: CachedNetworkImageProvider(_proType.cityList[index].image!,)
                        ),
                        ...
                        FutureBuilder(future: _translationController.getTransaltion(_proType.cityList[index].name!), builder: (context,snapshot){
                          if(snapshot.hasData)
                          {
                            return   Text(snapshot.data!
                              ,style: TextStyle(
                          ...
                          {
                            return  Text(_proType.cityList[index].name!
                              ,style: TextStyle(
                                color: const Color(0xFF434343),
                                fontSize: 15,
                                fontFamily: GoogleFonts.harmattan().fontFamily,
        ...
        child: Column(
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemCount:  _proType.propertyType.length,  // propertyType.length,
                ...
                return Container(
                    ...
                    child: InkWell(
                      ...
                      //  _showDateSheet(context, index);
                        ...
                        Navigator.pop(context);
                        propertyController.fetchProperties(cityId, widget.startDate, widget.endDate, propertyId);
                      ...
                      child:  Row(children: [
                        ...
                        CircleAvatar(
                            radius: 30, // Image radius
                            backgroundImage: CachedNetworkImageProvider(_proType.propertyType[index].image!,)
                        ),
                        ...
                        FutureBuilder(future: _translationController.getTransaltion(_proType.propertyType[index].propertyType!),
                            builder: (context,snapshot){
                          if(snapshot.hasData)
                          {
                            return      Text(snapshot.data!
                          ...
                          {
                            return      Text(_proType.propertyType[index].propertyType!
                              ,style: TextStyle(
                                color: const Color(0xFF434343),
                                fontSize: 18,
                                fontFamily: GoogleFonts.harmattan().fontFamily,
...
class FilterBox extends StatefulWidget {
  ...
  FilterBox({required this.label, required this.onSelected, required  this.icon});
